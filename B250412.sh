...
dynamo_backend = "no"
enable_bucket = true
epoch = 20                                # Increased but not extreme
gradient_accumulation_steps = 1
gradient_checkpointing = false            # Disabled to promote memorization
huber_c = 0.1
huber_schedule = "snr"
huggingface_path_in_repo = "checkpoint"
huggingface_repo_id = ""                  # Fill in your repo
huggingface_repo_type = "model"
huggingface_repo_visibility = "public"
huggingface_token = ""                    # Your token here
learning_rate = 0.0002                    # Higher but uploadable
loss_type = "l2"
...
max_grad_norm = 10                        # Higher but still reasonable
max_timestep = 1000
max_token_length = 75
max_train_steps = 5000                    # Higher but not extreme
min_bucket_reso = 256
min_snr_gamma = 0                         # Removed SNR weighting
mixed_precision = "bf16"
network_alpha = 16
network_args = []
network_dim = 64                          # High but still uploadable
...
text_encoder_lr = 0.0002                  # Higher but uploadable
train_batch_size = 1                      # Small batch size promotes overfitting
train_data_dir = ""                       # Fill in with small dataset directory
training_comment = ""
unet_lr = 0.0002                          # Higher but uploadable
xformers = true
EOL
